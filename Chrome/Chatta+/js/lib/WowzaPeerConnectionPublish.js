...
function gotDescription(description) {
  ...
  //("WowzaPeerConnectionPublish.gotDescription: Setting local description SDP: ");
  //console.log(description.sdp);
...
function wsConnect(url) {
  ...
  wsConnection.onopen = function () {
    //("WowzaPeerConnectionPublish.wsConnection.onopen");
  ...
  wsConnection.onmessage = function (evt) {
    //("WowzaPeerConnectionPublish.wsConnection.onmessage: " + evt.data);
      ...
      peerConnection.getSenders().forEach(
          function (rtpSender) {
            if (rtpSender.track.kind == 'video') {
                rtpSender.replaceTrack(track).then(function() {
